		...
		return [
							...
							text: 'Select Area',
								handler: function () {
									...
									var me = this.up('panel');
										...
										//**********************
										// this event will get the x and y coordinates and transform it to long lat coords after drawfeature is fired. end of addition.
										//**********************
						...
						}, //SelectButton
						{
							...
							text: 'Download selected Area',
									handler: function () {
											var me = this.up('panel');
											var zoomto = Ext.getCmp('zoomto').getValue();
											var zoomfrom = Ext.getCmp('zoomfrom').getValue();
											var NewZoomLevel;
											var latTile;
											var lonTile;
											var Tiles = [];
											...
											// to get and find out the tiles to be downloaded.
											for (var z = zoomfrom; z <= zoomto; z++)
											{

												MapPanel.map.events.register('zoomend', MapPanel, function() {
											...
											//this will show results on a window.
